                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-block">
                                <form action="/manager/order/create" class="number-tab-steps wizard-circle"
                                      id="createOrder">
                                    {{ csrf_field() }}
                                                        ...
                                                        <div class="card-body">
                                                            <div class="card-block">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <label for="end_location">{{__('orders.finish_location')}}</label>
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body collapse in">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div id="mapdiv" style="height: 350px; ">
                                            <div id="googlemap" style="width: 100%; height: 100%;border: 3px inset;">
                            ...
                            <div class="card-block" id="priceSummary"></div>
                        </div>
                    </div>
                </div>
            </div>
...
@section('scriptParts')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#personal_order').on("change", isPersonalOrder);
            $('#is_trip').on("change", isTrip);
            $('#passenger_is_client').on("change", isClient);
        ...
        function isPersonalOrder() {
            ...
            //     if ($('#is_personal_order').prop('checked')) {
        ...
        function getCompanies() {
            ...
            $.get('/common/client_company/get_companies/' + $('#client').val(), function (data) {
                //togglePersonal selectCompanyDiv
                // console.log(data);
                if (data) {
        ...
        function getDepartments() {
            console.log('/common/client_company/get_departments/' + $('#client').val() + '/' + $('#client_company').val());
        ...
        function getDrivers() {
            ...
            */
            ...
            $.get('{{asset('/manager/order/find_drivers')}}' + '/' + is_trip + '/' + package + '/' + duration + '/' + $('#start_date').val() + '/' + client_id + '/' + vehicle_class + '/0', function (data) {
                $('#driver').html(data);
                ///      console.log(data);
            });
        }
        ...
        function getClients() {
            ...
            $.get('{{asset('/manager/order/get_clients')}}' + '/' + company_id + '/' + department_id, function (data) {
        ...
        function getOrderHistroy(clientId) {
            $('#loading').show();
            $.get('/manager/order/getorderhistory/'.concat(clientId)).done(function (data) {
                if (data === "") {
                    $('#orderHistory').hide();
                    $('#loading').hide();
                } else {
        ...
        function getSpecialPackages() {
            ...
            $.get('{{asset('/manager/order/get_special_packages')}}' + '/' + client_id, function (data) {
                $('#package').html(data);
        ...
        function getCreditCard() {
            var client_id = ($('#client').val()) ? $('#client').val() : 0;
            $.get('/manager/order/getcreditcard' + '/' + client_id, function (data) {
        ...
        function getClientDirections(client_id) {
            $.get('/manager/order/getclientdirections/' + client_id, function (data) {
