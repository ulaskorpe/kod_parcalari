...
<script type="text/javascript">
    ...
    function getDrivers() {
      ...
      //  console.log(duration);
        ...
        $.get('{{asset('/manager/order/find_drivers')}}' + '/' + package + '/' + duration + '/' + dateTime +'/'+driver_id, function (data) {
            $('#driver').html(data);
           // console.log(data);
        });
    }
    ...
    function save() {
        $.post('/manager/order/createreorder/', $('#formReOrder').serialize(), function (data) {
