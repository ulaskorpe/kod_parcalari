            ...
            <div class="bs-callout-primary callout-border-left p-1">
                <div class="row">
                    ...
                    <div class="col-md-6 border-left border-left-grey">
                        ...
                        $start= (!empty($order->locations->first()->startlocation)) ? $order->locations->first()->startlocation->address : "";
                         $start_note= (!empty($order->locations->first()->startlocation)) ? $order->locations->first()->startlocation->address_note : "";
                         $end_note= (!empty($order->locations->first()->endlocation)) ? $order->locations->first()->endlocation->address_note : "";
                         $end= (!empty($order->locations->first()->endlocation)) ? $order->locations->first()->endlocation->address : "";
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">{{$start_note}}</div>
                        </div>
                        <div class="row top-buffer">
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-5">{{__('orders.address_note')}}:</div>
                            <div class="col-md-7">{{$end_note}}</div>
                        </div>
                    </div>
                </div>
